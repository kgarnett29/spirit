...
ADMINS = (('KB', 'kgarnett29@126.com'), )  # Log email to console when DEBUG = False
...
EMAIL_FROM = 'aoshanshouhuazhan@126.com'
EMAIL_HOST_PASSWORD = 'HQOWWUWXKTINUCGY'
EMAIL_PORT = 25
EMAIL_USE_TLS = True
# 对方看到的 email 发件人
DEFAULT_FROM_EMAIL = '鳌山收花站 <aoshanshouhuazhan@126.com>'
...
ST_SITE_URL = 'http://139.9.126.199/'
